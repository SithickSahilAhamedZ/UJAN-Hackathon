...
const translations = {
  en: {
    ...
    ourTechDesc1: 'PilgrimPath is built on a modern tech stack designed for scalability and real-time performance. We leverage live data feeds for crowd management, GPS for navigation, and a secure backend for bookings and reports.',
  ...
  hi: {
    ...
    aboutTitle: 'पिलग्रिमपाथ के बारे में',
    ...
    ourTech: 'हमारी तकनीक',
    ourTechDesc1: 'पिलग्रिमपाथ को मापनीयता और वास्तविक समय के प्रदर्शन के लिए डिज़ाइन किए गए एक आधुनिक टेक स्टैक पर बनाया गया है। हम भीड़ प्रबंधन के लिए लाइव डेटा फीड, नेविगेशन के लिए जीपीएस और बुकिंग और रिपोर्ट के लिए एक सुरक्षित बैकएंड का लाभ उठाते हैं।',
